(() => {
  ...
  const GLOBAL_EXTENT_COMPRESSION = 0.78;
  ...
  const RUNTIME_ASSETS = Object.freeze([
    ...
    ["./atlas-person-spacetime-label-engine.js?v=20260901-multiorder-pack", "ATLAS_PERSON_SPACETIME_LABEL_ENGINE"]
  ]);
