(() => {
  ...
  function ensureSpacetimeDomainAssets() {
    ensureStylesheet(
      ...
      "./atlas-person-spacetime-domain-colors.css?v=20260912-religion-warm-ivory-renderer",
  ...
  function ensurePersonDomainAssets() {
    ensureStylesheet(
      ...
      "./atlas-person-domain-palette.css?v=20260912-religion-warm-ivory-renderer",
