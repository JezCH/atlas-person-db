...
test('authority navigation loads the current spacetime renderer without a stale cache key', () => {
  ...
  assert.match(navScript, /atlas-person-spacetime-view\.js\?v=20260920-fit-minimum/);
  ...
  assert.match(spacetimeView, /atlas-person-spacetime-semantic-axis\.js\?v=20260920-range-100-1500/);
  ...
  assert.match(indexHtml, /atlas-main-authority-nav\.js\?v=20260920-catalog-status-v1/);
});
