...
test('authority navigation loads the current spacetime renderer without a stale cache key', () => {
  assert.match(navScript, /atlas-person-spacetime-view\.js\?v=20260901-uniform-076-label-chrome/);
  assert.match(navScript, /atlas-person-spacetime-view\.css\?v=20260901-uniform-076-label-chrome/);
  assert.match(indexHtml, /atlas-main-authority-nav\.js\?v=20260901-spacetime-uniform-076-label-chrome/);
});
