...
test('authority navigation loads the current spacetime renderer without a stale cache key', () => {
  assert.match(navScript, /atlas-person-spacetime-model\.js\?v=20260903-full-person-labels/);
  assert.match(navScript, /atlas-person-spacetime-view\.js\?v=20260903-full-person-labels/);
  assert.match(navScript, /atlas-person-spacetime-view\.css\?v=20260903-full-person-labels/);
  assert.match(spacetimeView, /atlas-person-spacetime-spatial-compile\.js\?v=20260903-full-person-labels/);
  ...
  assert.match(indexHtml, /atlas-main-authority-nav\.js\?v=20260903-spacetime-full-person-labels/);
});
