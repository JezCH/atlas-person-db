...
test('authority navigation loads the current spacetime renderer without a stale cache key', () => {
  assert.match(navScript, /atlas-person-spacetime-view\.js\?v=20260901-label-pack-multiorder/);
  assert.match(navScript, /atlas-person-spacetime-view\.css\?v=20260901-compact-shared-chrome/);
  assert.match(indexHtml, /atlas-main-authority-nav\.js\?v=20260901-spacetime-label-pack-multiorder/);
});
