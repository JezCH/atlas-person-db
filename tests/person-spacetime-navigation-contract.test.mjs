...
test('authority navigation loads the current spacetime renderer without a stale cache key', () => {
  ...
  assert.match(navScript, /atlas-person-spacetime-view\.js\?v=20260903-leaf-equal-map-order/);
  assert.match(navScript, /atlas-person-spacetime-view\.css\?v=20260903-leaf-equal-map-order/);
  ...
  assert.match(indexHtml, /atlas-main-authority-nav\.js\?v=20260903-spacetime-leaf-equal-map-order/);
});
