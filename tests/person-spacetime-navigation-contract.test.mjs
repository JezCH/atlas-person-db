...
test('authority navigation loads the current spacetime renderer without a stale cache key', () => {
  ...
  assert.match(navScript, /atlas-person-spacetime-view\.js\?v=20260919-shared-store-v1/);
  ...
  assert.match(indexHtml, /atlas-main-authority-nav\.js\?v=20260919-control-center-v1/);
});
