...
test("shared Person store and external-reference assets load before Person Main with fresh cache versions", () => {
  ...
  assert.match(html, /atlas-person-main\.js\?v=20260920-person-facets-sticky-v1/);
  ...
  const mainIndex = html.indexOf("atlas-person-main.js?v=20260920-person-facets-sticky-v1");
