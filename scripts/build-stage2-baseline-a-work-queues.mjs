...
const summary={schema:'atlas-stage2-baseline-a-work-queues-summary/v2',baseline:ledger.baseline,baseline_relationships:ledger.rows.length,unique_activity_ids:uniqueIds.size,dependency_counts:dependencyCounts,execution_class_counts:executionCounts,current_schema_cleanup_pending:0,production_mutation_authorized:false};
...
console.log(`ATLAS_BASELINE_A_WORK_QUEUES_OK rows=${ledger.rows.length} cleanup_pending=0`);console.log(JSON.stringify(summary,null,2));
