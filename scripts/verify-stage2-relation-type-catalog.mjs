...
if (readinessPolityCodes.size !== 3 || [...expectedPolity.keys()].some((code) => !readinessPolityCodes.has(code))) throw new Error('P5 readiness Polity relation code frontier drift');

console.log(JSON.stringify({
  marker:'ATLAS_STAGE2_RELATION_TYPE_CATALOG_OK',
  person_relation_types:6,
  polity_relation_types:3,
  exact_uuid_bindings:9,
