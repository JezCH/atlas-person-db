...
function auditBaselineBDocument(baseline) {
  ...
  const summary = Object.freeze({
    ...
    polity_event_name_review_candidates: eventLikePolityReview(polities, rows(datasets, "polity_names")).length,
    cross_category_name_collisions: crossCategoryNameCollisions(rows(datasets, "polity_names"), rows(datasets, "historical_event_names")).length
  });
  ...
  return Object.freeze({
    ...
    semantic_review: Object.freeze({
      event_like_polities: eventLikePolityReview(polities, rows(datasets, "polity_names")),
      polity_historical_event_name_collisions: crossCategoryNameCollisions(rows(datasets, "polity_names"), rows(datasets, "historical_event_names"))
    }),
