      ...
      try {
        ...
        await client.query(
          `insert into atlas_v2.authoring_manifest_runs(request_id,manifest_hash,person_id,relationship_id)
           values($1,$2,$3,$4)`,
          [requestId, hash, identity.id, relationshipId]
        );
...
module.exports = Object.freeze({ createAuthoringManifestService, manifestHash, requireManifest, activityFromManifest });