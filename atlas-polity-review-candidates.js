(() => {
  ...
  window.ATLAS_POLITY_REVIEW_CANDIDATES = Object.freeze({
    ...
    source_scope: "Production /api/atlas-read 2,260 Activity rows + current catalog + reviewed Stage 2 polity identity decisions",
    ...
    confirmed_merges: freezeRows([
      {
        ...
        status: "APPROVED_MERGE_PENDING_APPLY",
      ...
      },
      {
        ...
        suggested_action: "merge",
        status: "REVIEWED_MERGE_PENDING_RETIREMENT",
      ...
      },
      {
        ...
        suggested_action: "merge",
        status: "REVIEWED_MERGE_PENDING_APPLY",
      ...
      },
      {
        ...
        suggested_action: "merge",
        status: "APPROVED_MERGE_PENDING_RETIREMENT",
    ...
    review_candidates: freezeRows([
      {
        ...
        left: { name: "Emirate of Cordoba", ko: "코르도바 토후국" },
        right: { name: "Caliphate of Cordoba", ko: "코르도바 칼리파국" },
      ...
      },
      {
        ...
        left: { name: "Principality of Hungary", ko: "헝가리 대공국" },
        right: { name: "Kingdom of Hungary", ko: "헝가리 왕국" },
      ...
      },
      {
        ...
        left: { name: "Principality of Bulgaria", ko: "불가리아 공국" },
        right: { name: "Kingdom of Bulgaria", ko: "불가리아 왕국" },
      ...
      },
      {
        ...
        left: { name: "Principality of Montenegro", ko: "몬테네그로 공국" },
        right: { name: "Kingdom of Montenegro", ko: "몬테네그로 왕국" },
      ...
      },
      {
        ...
        left: { name: "Principality of Friedland", ko: "프리들란트 공국(후국)" },
        right: { name: "Duchy of Friedland", ko: "프리들란트 공작령" },
      ...
      },
      {
        ...
        left: { name: "State of Vietnam", ko: "베트남국" },
        right: { name: "Republic of Vietnam", ko: "베트남 공화국" },
      ...
      },
      {
        ...
        left: { name: "Central African Republic", ko: "중앙아프리카공화국" },
        right: { name: "Central African Empire", ko: "중앙아프리카 제국" },
      ...
      },
      {
        ...
        left: { name: "State of Ecuador", ko: "에콰도르국" },
        right: { name: "Republic of Ecuador", ko: "에콰도르 공화국" },
      ...
      },
      {
        ...
        left: { name: "Romania", ko: "루마니아" },
        right: { name: "Kingdom of Romania", ko: "루마니아 왕국" },
      ...
      },
      {
        ...
        left: { name: "Ostrogothic Confederation", ko: "동고트 정치연합" },
        right: { name: "Ostrogothic Kingdom", ko: "동고트 왕국" },
      ...
      },
      {
        ...
        left: { name: "Austria", ko: "오스트리아" },
        right: { name: "Republic of Austria", ko: "오스트리아 공화국" },
      ...
      },
      {
        ...
        left: { name: "Latvia", ko: "라트비아" },
        right: { name: "Republic of Latvia", ko: "라트비아 공화국" },
      ...
      },
      {
        ...
        left: { name: "Greece", ko: "그리스" },
        right: { name: "Kingdom of Greece", ko: "그리스 왕국" },
      ...
      },
      {
        ...
        left: { name: "Denmark", ko: "덴마크" },
        right: { name: "Kingdom of Denmark", ko: "덴마크 왕국" },
      ...
      },
      {
        ...
        left: { name: "Norway", ko: "노르웨이" },
        right: { name: "Kingdom of Norway", ko: "노르웨이 왕국" },
      ...
      },
      {
        ...
        left: { name: "France", ko: "프랑스" },
        right: { name: "Kingdom of France", ko: "프랑스 왕국" },
