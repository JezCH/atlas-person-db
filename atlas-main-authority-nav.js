(() => {
  ...
  function ensureSpacetimeAssets() {
    ...
    appendStylesheetOnce("./atlas-person-spacetime-view.css?v=20260903-c6-uncertainty");
    spacetimeAssetsPromise = loadScriptOnce("./atlas-person-spacetime-model.js?v=20260902-place-precision", () => Boolean(window.ATLAS_PERSON_SPACETIME_MODEL))
      .then(() => loadScriptOnce("./atlas-person-spacetime-view.js?v=20260903-c6-uncertainty", () => Boolean(window.ATLAS_PERSON_SPACETIME_VIEW)))
