(() => {
  ...
  function ensureDashboardAssets() {
    ...
    appendStylesheetOnce("./atlas-dashboard.css?v=20260924-namuwiki-absence-reasons-v2");
    dashboardAssetsPromise = ensureSpacetimeModel()
      .then(() => loadScriptOnce("./atlas-dashboard-model.js?v=20260924-namuwiki-absence-reasons-v2", () => Boolean(window.ATLAS_DASHBOARD_MODEL)))
      .then(() => loadScriptOnce("./atlas-dashboard.js?v=20260924-namuwiki-absence-reasons-v2", () => Boolean(window.ATLAS_DASHBOARD)))
