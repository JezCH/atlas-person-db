...
- the physical world extent applies one shared compression factor: **0.76**
...
Changing the 500% floor, 0.76 shared compression, 900–1,275 px base-world bounds, 140/36 px shared chrome geometry, or prohibition on local compression requires explicit review.
